...
CREATE TABLE SpotifyClone.user_playback(
  user_id INT NOT NULL,
...
INSERT INTO SpotifyClone.user(user, age, signature_date, signature_id)
VALUES
...
INSERT INTO SpotifyClone.music(name, duration_sec, album_id)
VALUES
  ('Soul For Us', 200, 1),
...
INSERT INTO SpotifyClone.user_playback(user_id, music_id, played_in)
VALUES
